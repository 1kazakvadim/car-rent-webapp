...
(
    ...
    `passport_number`       varchar(45) COLLATE utf8_unicode_ci  NOT NULL,
...
(
    ...
    UNIQUE KEY `passport_data_id_UNIQUE` (`passport_data_id`),
    KEY `passport_data_id_idx` (`passport_data_id`),
    KEY `user_group_id_idx` (`user_role_id`),
...
(
    ...
    `reason_of_cancellation` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
    `rental_cost`            double unsigned                      NOT NULL,
    PRIMARY KEY (`id`),
...
(
    ...
    `damage_information` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
